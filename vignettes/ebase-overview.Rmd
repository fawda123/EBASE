...
The model fit can be assessed by comparing the observed and modelled values for dissolved oxygen with the `fit_plot()` function.  Estimated values are shown as line and observed values are shown as points.
