...
#' 
#' @return Formatted output for \code{\link{ebase}} with interpolated rows removed as defined by \code{maxinterp}
#' @export
#'
#' @examples
#' library(dplyr)
...
#' 
#' ebase_form(out, dat, interval = 900, maxinterp = 43200 / interval) 
#' }
