...
#' stopCluster(cl)
#' }
ebase <- function(dat, H, interval, ndays = 1, aprior = c(4, 1), rprior = c(300, 50), bprior = c(0.251, 0.1), bmax = 0.502, doave = TRUE, maxinterp = 43200 / interval,  n.iter = 10000, update.chains = TRUE, n.burnin = n.iter*0.5, n.chains = 3, n.thin = 10, progress = FALSE, model_file = NULL){
